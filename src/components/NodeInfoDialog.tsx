        ...
        switch (electroInterface.type) {
            case "Consumer": {
                ...
                return (
                    <>
                        <div>
                            Last: {formatNumberWithMaxTwoDecimals(
            ...
            case "Distributor": {
                ...
                return (
                    <>
                        <div>
                            Last: {formatNumberWithMaxTwoDecimals(distributor.energyFlow / 1000)}kW
                        </div>
                        <div
                            className={`${distributor.energyFlow > distributor.allowedEnergyFlow
                                ? "text-red-600 font-bold"
                                : "opacity-75"
                                }`}
                        >
            ...
            case "Producer": {
                ...
                return (
                    <>
                        <div>
                            Last: {formatNumberWithMaxTwoDecimals(producer.energyFlow / 1000)}kW
                        </div>
                        <div
                            className={`${producer.energyFlow > producer.allowedEnergyFlow
                                ? "text-red-600 font-bold"
                                : "opacity-75"
                                }`}
                        >
